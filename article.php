...
if (!$article) {
    ...
    echo '<section class="page-banner"><div class="container"><h1>Article Not Found</h1><p>The article you are looking for does not exist.</p></div></section>';
    echo '<section class="section"><div class="container" style="text-align:center;"><a href="' . SITE_URL . '/articles.php" class="btn btn-primary">Back to Articles</a></div></section>';
