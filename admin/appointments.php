...
<div class="admin-layout">
    ...
    <div class="admin-content">
        ...
        <div class="table-container">
                                ...
                                <td>
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <select name="status" onchange="this.form.submit()"
                                            style="padding:0.3rem;border-radius:5px;border:1px solid #D7DDD9;font-size:0.8rem;">
            ...
            <?php else: ?>
                <p style="color:#999;text-align:center;padding:2rem;">No appointments received yet.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
